...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backround=-11463712;
		int endColor=-9502714;
	...
	if(mouseColor==endColor) {
		showImage("funny yay pic.jpg");
		JOptionPane.showMessageDialog(null, "You have reached the endpoint!!!!!");
		System.exit(0);
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("evil witch laugh.wav"));
