...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				"Just incase you ever find yourself trying to cross a piranha infested river,"
						+ "here's one soulution to that problem.");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + adjective
				+ " during the day,\n so cross the river at " + "night. Piranhas are attracted to fresh " 
                +liquid + " and will most likely take a bite \n out of your "+bodypart+" if you "+verb+". Whatever"
				+ "you do, if you have an open wound, try to find another way to get "
				+ "back to the "+place+". Good luck " + name + "!!!");
